...
public class FileUpload {
	...
	public static void main(String[] args) {
	    ...
	    //single file upload - 
	    driver.findElement(By.xpath("//input[@id='filesToUpload']")).sendKeys("C:\\Program Files (x86)\\Google\\Img.jpg");
	    
	    if(driver.findElement(By.xpath("//ul[@id='fileList']//li")).getText().equals("Img.jpg"))
	    {
	    ...
	    {
	        System.out.println("Files are not uploaded or inc");
	    }
	}
